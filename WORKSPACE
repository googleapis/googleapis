...
##############################################################################
# Java microgenerator.
_gapic_generator_java_version = "1.0.2"
...
http_archive(
    ...
    strip_prefix = "gapic-generator-python-0.43.2",
    urls = ["https://github.com/googleapis/gapic-generator-python/archive/v0.43.2.zip"],
)
