...
def switched_rules_by_language(
    ...
    # Remove these legacy rules once the monolith generator has been decommisioned for PHP.
    rules["php_proto_library_legacy"] = _switch(
        php,
        "@com_google_api_codegen//rules_gapic/php:php_gapic.bzl",
    )
    rules["php_grpc_library_legacy"] = _switch(
        php and grpc,
        "@com_google_api_codegen//rules_gapic/php:php_gapic.bzl",
    )
    rules["php_gapic_library_legacy"] = _switch(
        php and grpc and gapic,
        "@com_google_api_codegen//rules_gapic/php:php_gapic.bzl",
    )
    rules["php_gapic_assembly_pkg_legacy"] = _switch(
        php and grpc and gapic,
