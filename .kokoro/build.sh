...
${KOKORO_ROOT}/tools/bazel --output_user_root=${KOKORO_ROOT}/tools/bazel_root build --keep_going //google/...
${KOKORO_ROOT}/tools/bazel --output_user_root=${KOKORO_ROOT}/tools/bazel_root test --keep_going //google/...