...
import * as speech_client_config from './speech_client_config.json';
import fs from 'fs';
 ...
 */
const gapicConfig = JSON.parse(fs.readFileSync(path.join(dirname, 'speech_client_config.json'),'utf8'));
