...
import * as adaptation_client_config from './adaptation_client_config.json';
import fs from 'fs';
 ...
 */
const gapicConfig = JSON.parse(fs.readFileSync(path.join(dirname, 'adaptation_client_config.json'),'utf8'));
